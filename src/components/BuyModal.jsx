...
const BuyModal = ({ close, buyTokens }) => {
	const styles = {
		...
		closeX: `w-full h-[50px] flex items-center justify-end mb-[20px] text-[#29283D]`,
		title: `text-3xl font-bold flex flex-1 items-center mt-[20px] justify-center mb-[40px] text-[#29283D]`,
		content: `flex w-full mb-[30px] text-xl justify-center text-[#29283D]`,
		...
		price: `w-full h-full flex justify-center items-center mt-[20px] font-bold text-3xl text-[#29283D]`,
		...
		<div className={styles.container}>
			{isLoading ? (
				...
				<>
					...
					<div className={styles.title}>Buy More Dropp Coins Here!</div>

...
const Transaction = ({ item }) => {
	const styles = {
		container: ` w-[full] flex flex-col items-center border-[#29283D] border-2 rounded-lg shadow-lg bg-[#29283D]`,
		...
		buyAgainBtn: `bg-[#F28E54] font-bold rounded-full h-[40px] w-[150px] cursor-pointer text-white text-center flex items-center justify-center `,
		etherscanBtn: `font-bold rounded-full h-[40px] w-[150px] cursor-pointer text-white text-center flex items-center justify-center bg-[#1B1C2C]`,
	}
					...
					<div className={styles.container} key={index}>
						...
						<div className={styles.content}>
							...
							<div className={styles.item}>
								<Image className="object-cover" src={asset.src} alt="item" height={100} width={100} />
